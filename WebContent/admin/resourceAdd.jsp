	...
	<div data-options="region:'center',border:false" title="" style="overflow: hidden;">
		<form id="form" method="post">
			<table class="table table-hover table-condensed">
				<tr>
					<th>资源名称</th>
					<td><input name="name" type="text" placeholder="请输入资源名称" class="easyui-validatebox" data-options="required:true" value=""  style="height: 40px"></td>
					<th>资源类型</th>
				...
				<tr>
					<th>资源路径</th>
					<td colspan="3"><input name="url" type="text" placeholder="请输入资源路径" class="easyui-validatebox" value="" style="width: 360px;height: 40px"></td>
				</tr>
				<tr>
					<th>菜单图标</th>
