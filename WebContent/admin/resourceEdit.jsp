...
<script type="text/javascript">
	$(function() {
		...
		$('#pid').combotree({
			url : '${pageContext.request.contextPath}/resourceController/allMenuTree',
			parentField : 'pid',
			lines : true,
			panelHeight : 'auto',
			value : '${resource.pid}',
		...
		<form id="form" method="post">
			<table class="table table-hover table-condensed">
				<tr>
					<th>资源名称</th>
					<td>
						<input name="name" type="text" placeholder="请输入资源名称" class="easyui-validatebox"  style="height: 40px" data-options="required:true" value="${resource.name} " >
				...
				<tr>
					<th>资源路径</th>
					<td colspan="3"><input name="url" type="text" placeholder="请输入资源路径" class="easyui-validatebox" value="${resource.url}" style="width: 360px;height: 40px"></td>
				</tr>
				<tr>
					<th>菜单图标</th>
